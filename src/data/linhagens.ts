...
export const linhagens: Linhagem[] = [
  ...
  },
  {
    ...
    tema: '#4A365F',
    criaturas: ['serpreita', 'maligroso', 'mortiposa', 'carnicalha', 'mortume', 'decreptera', 'laranharta', 'enjaulupa', 'lunaranha', 'wendivora', 'restritupa', 'hematocrata', 'paplicata','pupargula','harpitera', 'zunambularva', 'esporantalho', 'assombralada', 'mumifigarta', 'sarcosulo', 'isetyx', 'erubis', 'falsilha','aberrosulo','frankaptera','frankopata','ipupiarta','tesaurea','sirentria','carrantano','flamecante','pupandoura','gorgondusa','quimerydra', 'fantasioche','apotroche','polterposa','chapelirio', 'manicumulo','gargalhaco'],
  },
  {
    id: 'mosquitos',
    nome: 'Mosquitos',
